 	...
 	<br><br>
  	 <a href="add.php"><button type="button" class="btn btn-outline-primary btn-lg">Add Items</button></a><br><br>
  	  ...
  	  <button type="button" class="btn btn-outline-primary btn-lg" onclick="Deletequery()">Clear Items</button><br><br>
  	   <button type="button" class="btn btn-outline-primary btn-lg">Add Staff</button><br><br>
  	 <button type="button" class="btn btn-outline-primary btn-lg">Manage Staff</button><br><br>
  	 <button type="button" class="btn btn-outline-primary btn-lg">View Orders</button><br><br>
